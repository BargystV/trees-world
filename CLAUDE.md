# Trees World — Документация проекта
...
- **Обновлять README.md** при любых изменениях, которые должны быть отражены для пользователя: новые клавиши управления, новые механики симуляции, изменения в требованиях или способе запуска, новые модули.
